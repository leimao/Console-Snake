...
Snake::Snake()
{
    ...
    this->gameBoardWidth = this->screenHeight - this->instructionWidth;
    this->gameBoardHeight = this->screenWidth - this->informationHeight;
...
void Snake::createFood()
{
    ...
    for (int i = 1; i < this->gameBoardHeight - 1; i ++)
    {
        for (int j = 1; j < this->gameBoardWidth - 1; i ++)
        {
...
void Snake::initializeSnake()
{
    ...
    int centerX = this->gameBoardWidth / 2;
    int centerY = this->gameBoardHeight / 2;
    for (int i = 0; i < this->initialSnakeLength; i ++)
    {
        this->snake.push_back(SnakeBody(centerX, centerY + i));
    }
    this->snake.push_back(SnakeBody(centerX, centerY));
